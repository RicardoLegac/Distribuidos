...
#line 16 "prueba.y"
                    { printf("En decimal = %d\nEn hexadecimal =0x%x\n ", yyvsp[-1],yyvsp[-1]); }
#line 1304 "prueba.tab.c"
    break;

  case 5:
#line 20 "prueba.y"
                  { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1310 "prueba.tab.c"
    break;

  case 6:
#line 21 "prueba.y"
                  { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1316 "prueba.tab.c"
    break;

  case 8:
#line 25 "prueba.y"
                   { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1322 "prueba.tab.c"
    break;

  case 9:
#line 26 "prueba.y"
                   { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1328 "prueba.tab.c"
    break;

  case 11:
#line 30 "prueba.y"
              { yyval = yyvsp[0] >= 0? yyvsp[0] : - yyvsp[0]; }
#line 1334 "prueba.tab.c"
    break;


#line 1338 "prueba.tab.c"
